...
fun ChangePhoneScreen(
    onBack: () -> Unit,
    vm: ChangePhoneViewModel = hiltViewModel(),
) {
    ...
    SettingsScaffold(
        ...
        SettingsCard {
            Column(
                ...
                OutlinedTextField(
                    value = ui.newPhone,
                    onValueChange = vm::onNewPhoneChange,
                    label = { Text("新手机号") },
                    singleLine = true,
        ...
        Button(
            ...
            enabled = !ui.loading && ui.newPhone.isNotBlank() && ui.code.isNotBlank(),
